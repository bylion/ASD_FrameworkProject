...
public abstract class AccountDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        extraFieldsPanel.setBounds(12, 252, 280, 50);

        typePanel = createTypes();
        typePanel.setBounds(36, 12, 280, 72);
        ...
        nameField.setBounds(122, 108, 156, 20);
        emailField.setBounds(122, 132, 156, 20);
        streetField.setBounds(122, 156, 156, 20);
        cityField.setBounds(122, 180, 156, 20);
        stateField.setBounds(122, 204, 156, 20);
        zipField.setBounds(122, 228, 156, 20);
